      ...
      <div className="w-full mx-auto">
        <div className="footer p-10">
          <div>
            ...
            <Link to="" className="link link-hover">Contacto</Link>
            <Link to="" className="link link-hover">Preguntas frecuentes</Link>
          </div>
          <div>
            ...
            <Link to="" className="link link-hover">Productos de temporada</Link>
          </div>
          <div>
            {isLoggedIn && user && (
              <>
                ...
                <Link to="" className="link link-hover">Configuración</Link>
              </>
            )}
          </div>
          <div>
            ...
            <div className="grid grid-flow-col gap-4">
              <a href="https://github.com/Jojocg/Sansofe-Project-frontend" target="_blank" rel="noopener noreferrer">
                <Github className="w-7 h-7 text-primary-content" />
              </a>
